...
test_that("Effect size reuslts for mutation scores", {
  ...
  avmr_effectsize <- dominoReplicate::effectsize_accurate(dr_StudentResidence$mutationScore, avmr_StudentResidence$mutationScore)$size
  avmd_effectsize <- dominoReplicate::effectsize_accurate(dr_StudentResidence$mutationScore, avmd_StudentResidence$mutationScore)$size
  rand_effectsize <- dominoReplicate::effectsize_accurate(dr_StudentResidence$mutationScore, rand_StudentResidence$mutationScore)$size
