...
test_that("Effect size results for test generation timings", {
  ...
  #dr_StudentResidence <- dominoReplicate::transform_execution_times_for_threshold(dr_StudentResidence, 1000)
  #avmr_StudentResidence <- dominoReplicate::transform_execution_times_for_threshold(avmr_StudentResidence, 1000)
  #avmd_StudentResidence <- dominoReplicate::transform_execution_times_for_threshold(avmd_StudentResidence, 1000)
  #rand_StudentResidence <- dominoReplicate::transform_execution_times_for_threshold(rand_StudentResidence, 1000)

  # Testing Effect size

  avmr_effectsize <- dominoReplicate::effectsize_accurate(dr_StudentResidence$testgenerationtime, avmr_StudentResidence$testgenerationtime)$size
  avmd_effectsize <- dominoReplicate::effectsize_accurate(dr_StudentResidence$testgenerationtime, avmd_StudentResidence$testgenerationtime)$size
  rand_effectsize <- dominoReplicate::effectsize_accurate(dr_StudentResidence$testgenerationtime, rand_StudentResidence$testgenerationtime)$size
